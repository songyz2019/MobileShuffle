...
if __name__ == '__main__':
    ...
    parser.add_argument('-GPU_num', type=int, default=0, help='GPU_num')
    ...
    # train_dataset = ImageFolder(root='./GF3_split/train', transform=transform_train)
    # test_dataset = ImageFolder(root='./GF3_split/test',transform=transform_test)
    ...
    # train_dataset = LoadData(txt_path="./GF3/GF3_train.txt",train_flag=True)
